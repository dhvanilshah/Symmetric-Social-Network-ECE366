package cool.disc.server.test.handler.user;
...
import cool.disc.server.test.model.User;
...
public class UserHandlers {
    ...
    @SuppressWarnings("Duplicates")
    public Response<String> acceptRequest(final RequestContext requestContext){
        String friend_id = requestContext.pathArgs().get("id");
